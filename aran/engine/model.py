...
from aran.cfg import TASK2DATA, get_cfg, get_save_dir
# from aran.hub.utils import HUB_WEB_ROOT
from aran.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from aran.utils import ASSETS, DEFAULT_CFG_DICT, LOGGER, RANK, SETTINGS, callbacks, checks, emojis, yaml_load
...
class Model(nn.Module):
    ...
    def __init__(
        ...
        # Check if aran HUB model from https://hub.aran.com
        ...
        model = checks.check_model_file_from_stem(model)
    ...
    def _get_hub_session(model: str):
        from aran.hub.session import HUBTrainingSession
    ...
    def load(self, weights: Union[str, Path] = "aran.pt") -> "Model":
        self._check_is_pytorch_model()
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        """
        self._check_is_pytorch_model()
        from aran import __version__
        from datetime import datetime

        updates = {
            "date": datetime.now().isoformat(),
            "version": __version__,
            "license": "AGPL-3.0 License (https://aran.com/license)",
            "docs": "https://docs.aran.com",
        }
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (sys.argv[0].endswith("yolo") or sys.argv[0].endswith("aran")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        if not hasattr(self.predictor, "trackers"):
            from aran.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        """
        self._check_is_pytorch_model()
        from aran.utils.benchmarks import benchmark
    ...
    def train(
        ...
        **kwargs,
        ...
        """
        self._check_is_pytorch_model()
        if hasattr(self.session, "model") and self.session.model.id:  # aran HUB session with loaded model
            if any(kwargs):
    ...
    def tune(
        ...
        **kwargs,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from aran.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        """
        from aran.nn.autobackend import check_class_names
