...
from aran.utils.metrics import OKS_SIGMA
from aran.utils.ops import crop_mask, xywh2xyxy, xyxy2xywh
from aran.utils.tal import RotatedTaskAlignedAssigner, TaskAlignedAssigner, dist2bbox, dist2rbox, make_anchors
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError(
                ...
                "as an example.\nSee https://docs.aran.com/datasets/segment/ for help."
            ) from e
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError(
                ...
                "as an example.\nSee https://docs.aran.com/datasets/obb/ for help."
            ) from e
