...
from aran.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file

GITHUB_ASSETS_REPO = "aran/assets"
GITHUB_ASSETS_NAMES = (
...
def delete_dsstore(path, files_to_delete=(".DS_Store", "__MACOSX")):
    ...
    Example:
        ```python
        from aran.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=(".DS_Store", "__MACOSX"), progress=True):
    ...
    Example:
        ```python
        from aran.utils.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=(".DS_Store", "__MACOSX"), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from aran.utils.downloads import unzip_file
...
def check_disk_space(url="https://ultralytics.com/assets/coco128.zip", path=Path.cwd(), sf=1.5, hard=True):
    ...
    Args:
        url (str, optional): The URL to the file. Defaults to 'https://aran.com/assets/coco128.zip'.
...
def get_google_drive_file_info(link):
    ...
    Example:
        ```python
        from aran.utils.downloads import get_google_drive_file_info
...
def get_github_assets(repo="aran/assets", version="latest", retry=False):
    """
    Retrieve the specified version's tag and assets from a GitHub repository. If the version is not specified, the
    function fetches the latest release assets.

    Args:
        repo (str, optional): The GitHub repository in the format 'owner/repo'. Defaults to 'aran/assets'.
    ...
    Example:
        ```python
        tag, assets = get_github_assets(repo='aran/assets', version='latest')
        ```
    """
...
def attempt_download_asset(file, repo="ultralytics/assets", release="v8.1.0", **kwargs):
    ...
    Example:
        ```python
        file_path = attempt_download_asset('yolov5s.pt', repo='aran/assets', release='latest')
        ```
    """
    from aran.utils import SETTINGS  # scoped for circular import
