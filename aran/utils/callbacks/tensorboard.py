...
from aran.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr

try:
    # WARNING: do not move SummaryWriter import due to protobuf bug https://github.com/aran/aran/pull/4674
    ...
    from aran.utils.torch_utils import de_parallel, torch
